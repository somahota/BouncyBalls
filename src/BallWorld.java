...
public class BallWorld extends JPanel {
   ...
   private boolean isDarkModeEnabled = false; // Flag for dark mode on/off
...
//    }
            ...
            for (int j = 0; j < currentNumBalls; j++) {
               if (i < j) {
                  ...
                  if (balls[i].earliestCollisionResponse.t < tMin) {
                     ...
                     //balls[i] = new Ball(200, 80, 70, 6, -84, Color.WHITE);   // Uncomment this out to see a different version of the game
                  }
   ...
   class DrawCanvas extends JPanel {
      ...
      public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < currentNumBalls; i++) {
         ...
         g.drawString("Current number of balls:" + total,20,30);
   ...
   class ControlPanel extends JPanel {
      ...
      public ControlPanel() {
         ...
         final JButton deleteControl = new JButton("Delete a Ball");
         this.add(deleteControl);
         deleteControl.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                  currentNumBalls--;
                  if (currentNumBalls == 0) {
                     // Disable the button, as there is no more ball
                     deleteControl.setEnabled(false);
                  }
               }
            });
//    JButton darkMode = new JButton("Dark Mode ON");
...
//      });
         ...
         this.add(new JLabel("Dark Mode ON/OFF"));
         this.add(darkMode);
